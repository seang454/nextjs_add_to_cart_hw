...
export default function ProductCard({ id, title, description, price, images, category }: ProductType) {
    return (
        <div key={id} className="bg-white rounded-lg overflow-hidden shadow-lg max-w-sm">
            ...
            <div className="p-4">
                ...
                <p className="text-gray-500 text-xs mb-2">Category: {category.name}</p>
